...
nome_artista VARCHAR(250) NOT NULL
)engine=InnoDB;
...
INSERT INTO SpotifyClone.albuns(album_id, nome_album, artista_id)
VALUES (1, 'Envious', 1);
INSERT INTO SpotifyClone.albuns(album_id, nome_album, artista_id)
...
INSERT INTO SpotifyClone.usuarios(usuario_id, nome_usuario, idade, plano_id)
VALUES (1, 'Thati', 23, 1);
INSERT INTO SpotifyClone.usuarios(usuario_id, nome_usuario, idade, plano_id)
...
nome_cancao VARCHAR(250) NOT NULL,
