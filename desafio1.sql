...
CREATE TABLE cancoes (
    ...
    CONSTRAINT fk_cancoes_album FOREIGN KEY (id_album)
        REFERENCES album (id)
)  ENGINE=INNODB;
CREATE TABLE historico_de_reproducoes (
    ...
    CONSTRAINT fk_historico_de_reproducoes_usuario FOREIGN KEY (id_usuario)
        REFERENCES usuario (id),
    CONSTRAINT fk_historico_de_reproducoes_cancoes FOREIGN KEY (id_cancao)
...
CREATE TABLE seguindo_artistas (
    ...
    CONSTRAINT fk_seguindo_artistas_usuario FOREIGN KEY (id_usuario)
        REFERENCES usuario (id),
    CONSTRAINT fk_seguindo_artistas_artista FOREIGN KEY (id_artista)
        REFERENCES artista (id)
)  ENGINE=INNODB;
