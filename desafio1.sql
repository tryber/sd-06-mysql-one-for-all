...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`albuns` (
  ...
  INDEX `fk_albuns_artistas_id_idx` (`artistas_id` ASC) VISIBLE,
  CONSTRAINT `fk_albuns_artistas_id`
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`musicas` (
  ...
  INDEX `fk_musicas_albuns_id_idx` (`albuns_id` ASC) VISIBLE,
  CONSTRAINT `fk_musicas_albuns_id`
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`usuarios` (
  ...
  INDEX `fk_usuarios_planos_id_idx` (`planos_id` ASC) VISIBLE,
  CONSTRAINT `fk_usuarios_planos_id`
